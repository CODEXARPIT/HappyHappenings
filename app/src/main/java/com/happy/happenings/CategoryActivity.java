...
public class CategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sp.edit().putString(ConstantUrl.CATEGORY_ADD_EDIT, "Add").commit();
                sp.edit().putString(ConstantUrl.CATEGORY_ID, "").commit();
                sp.edit().putString(ConstantUrl.CATEGORY_NAME, "").commit();
                sp.edit().putString(ConstantUrl.CATEGORY_IMAGE, "").commit();
    ...
    private class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.MyHolder> {
        ...
        public CategoryAdapter(CategoryActivity adminActivity, ArrayList<CategoryList> arrayList) {
