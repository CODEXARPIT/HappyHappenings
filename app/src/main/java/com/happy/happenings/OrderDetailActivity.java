...
public class OrderDetailActivity extends AppCompatActivity {
        ...
        if (sp.getString(ConstantUrl.ORDER_PAGE, "").equalsIgnoreCase("")) {
            ...
            userCall.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    makeCall(OrderActivity.arrayList.get(position).getUserContact());
                }
            });
            ...
            vendorCall.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    makeCall(OrderActivity.arrayList.get(position).getVendorContact());
                }
            });
        } else {
            ...
            userCall.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    makeCall(MyOrderFragment.arrayList.get(position).getUserContact());
                }
            });
            ...
            vendorCall.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    makeCall(MyOrderFragment.arrayList.get(position).getVendorContact());
                }
            });
        }
    ...
    private void makeCall(String contact) {
        if (ContextCompat.checkSelfPermission(OrderDetailActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(OrderDetailActivity.this, new String[]{Manifest.permission.CALL_PHONE}, 100);
        } else {
